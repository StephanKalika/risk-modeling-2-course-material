...
data31 <- read.csv('RegressionData.csv', header=TRUE)
apply(data31, 2, mean)
apply(data31, 2, sd)
...
plot(data31$x3, data31$y3, xlim=c(0, 20), ylim=c(0, 15), pch=22, xlab='x', ylab='y')
points(data31$x3, reg3$fitted.values, type='l', col='red', lwd=4)
